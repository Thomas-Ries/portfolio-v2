<template>
    ...
    <section class="relative h-80">
        ...
        class="flex flex-col px-4 pt-12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-16 w-full">
            ...
            class="text-bamboo text-5xl font-bold text-center">
                Network Plus que Pro
            </h1>
            <p class="text-gray-800 mt-3 text-center
            md:mt-2">
                Site vitrine de l'entreprise à destination des franchisés
            </p>
        </div>
    </section>
    ...
    md:flex-row md:items-start md:mt-0">
        ...
        <img
        src="../../assets/img/projects/network.png"
        alt="acheter-ou"
        ...
        md:px-4 md:border-l-2 md:border-gray-200">
            ...
            md:ml-8 md:mt-20 md:w-full md:pr-6">
                ...
                md:mt-4">
                    <li>
                        Prise en main et initilisation rapide du projet
                    </li>
                    <li>
            ...
            md:ml-8 md:mt-20 md:w-full md:pr-6">
                ...
                md:mt-4">
                    <li>
                        Aide apportée par mon lead-dev dans l'initialisation du projet en local (docker)
                    </li>
                    <li>
            ...
            <a
            href="https://www.network-plus-que-pro.fr/"
            target="_blank"
