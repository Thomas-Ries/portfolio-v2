<template>
    ...
    <section class="relative h-80">
        ...
        class="flex flex-col px-4 pt-12 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-16 w-full">
            ...
            md:mt-2">
                Développpement d'un CMS maison
            </p>
        </div>
    </section>
    ...
    md:flex-row md:items-start md:mt-0">
        ...
        <img
        src="../../assets/img/projects/page-builder.jpg"
        alt="acheter-ou"
        ...
        md:px-4 md:border-l-2 md:border-gray-200">
            ...
            md:ml-8 md:mt-0 md:w-full md:pr-6">
                ...
                md:mt-4">
                    Développement d'un CMS maison permettant aux intégrateurs de créer des sites facilement et rapidement pour nos clients sans avoir à ce soucier d'un quelconque développement.
                </p>
            ...
            md:ml-8 md:mt-20 md:w-full md:pr-6">
                ...
                md:mt-4">
                    <li>
                        Projet 100% en vanilla Javascript ES6 (Vue.js servant uniquement de wrapper)
                    </li>
                    <li>
                        Notions de block scop au sein des modules et fonctions
                    </li>
                    <li>
                        Recherches d'informations en ligne compliquées
                    </li>
                </ul>
            </div>
