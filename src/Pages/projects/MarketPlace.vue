...
md:flex-row md:items-start md:mt-0">
    ...
    <img
    src="../../assets/img/projects/acheter-ou.png"
    alt="acheter-ou"
    ...
    md:px-4 md:border-l-2 md:border-gray-200">
        ...
        md:ml-8 md:mt-20 md:w-full md:pr-6">
            ...
            md:mt-4">
                <li>
                    Réappropriation de la documentation Vue2, Bootstrap et Blade
                </li>
                <li>
                    Montée en compétences par le biais de formations personnelles en versionning
                </li>
                <li>
                    Montée en confiance suite à ce projet
                </li>
            </ul>
        </div>
        <a
        href="https://www.acheter-ou.shop/"
        target="_blank"
